...
# -*- coding: utf-8 -*-
#
# Percona Distribution for MySQL documentation build configuration file, created by
# sphinx-quickstart on Wed June 3 14:42:57 2020.
#
...
latex_documents = [
  ('index', # source start file
   #target name, such as PerconaDistributionForMongoDB-5.7.tex
   '.'.join(['-'.join([''.join(project.split()), version]), 'tex']), 
   ' '.join([project, 'Documentation']), # title, such as Percona Distribution for MySQL Documentation
   copyright, 
...
latex_documents = [
    (master_doc, 'PerconaDistributionforMySQL.tex', 'Percona Distribution for MySQL Documentation',
     copyright, 'manual'),
]
...
man_pages = [('index', # source start file
              ''.join([''.join(project.lower().split()),
                       ''.join(version.split('.'))]), # name, such as perconabackupformongodb123
              ' '.join([project, version, u'Documentation']), # description, such as Percona Distribution for MySQL 8.0 Documentation
              [copyright], # authors
              1 # manual section
)]
...
texinfo_documents = [
    (master_doc, 'PerconaDistributionforMySQL', 'Percona Distribution for MySQL Documentation',
     copyright, 'PerconaDistributionforMySQL', 'One line description of project.',
     'Miscellaneous'),
]
